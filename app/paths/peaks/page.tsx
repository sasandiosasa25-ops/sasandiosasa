          ...
          {t.peaks.map((peak, idx) => (
            <SwiperSlide key={idx} className="!w-[95%] sm:!w-[85%] md:!w-[70%]" style={{ maxWidth: '900px' }}>
              <div className="relative h-full flex items-center justify-center p-2 sm:p-4 md:p-8">
                <div className="relative w-full h-44 sm:h-60 md:h-96 lg:h-[420px] rounded-xl md:rounded-2xl overflow-hidden shadow-2xl bg-white/80 mx-auto" style={{ marginRight: '0', marginLeft: 'auto', maxWidth: '95vw' }}>
                  {/* Image */}
                  <img 
                    src={peak.image} 
                    alt={peak.title}
