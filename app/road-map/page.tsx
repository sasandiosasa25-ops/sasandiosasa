...
export default function RoadMapPage() {
  ...
  const destinations: Record<DestinationKey, Destination> = {
    ...
    'dar-es-salaam': {
      ...
      mapUrl: 'https://www.google.com/maps/place/Dar+es+Salaam,+Tanzania/@-6.7924,39.2083,12z'
    },
    'selous': {
      ...
      mapUrl: 'https://www.google.com/maps/place/Selous+Game+Reserve/@-8.0833,38.2500,10z'
    },
    'mikumi': {
      ...
      mapUrl: 'https://www.google.com/maps/place/Mikumi+National+Park/@-7.3833,37.0000,11z'
    },
    // Northern Circuit
    'arusha-np': {
      ...
      mapUrl: 'https://www.google.com/maps/place/Arusha+National+Park/@-3.2333,36.8833,12z'
    },
    'tarangire': {
      ...
      mapUrl: 'https://www.google.com/maps/place/Tarangire+National+Park/@-3.8333,36.0000,11z'
    },
    'serengeti': {
      ...
      mapUrl: 'https://www.google.com/maps/place/Serengeti+National+Park/@-2.3333,34.8333,10z'
    },
    'ngorongoro': {
      ...
      mapUrl: 'https://www.google.com/maps/place/Ngorongoro+Crater/@-3.1667,35.5833,12z'
    },
    // Coast
    'pangani': {
      name: 'Pangani',
      ...
      mapUrl: 'https://www.google.com/maps/place/Pangani,+Tanzania/@-5.4167,38.9833,13z'
    },
    'maziwe': {
      name: 'Maziwe Island',
      ...
      mapUrl: 'https://www.google.com/maps/place/Maziwe+Island/@-5.2833,39.0500,14z'
    },
  };
            ...
            {Object.entries(destinations).map(([id, dest]) => (
              <div key={id} id={id} className="scroll-mt-32">
                <div className="bg-white/5 backdrop-blur-sm border-2 border-brand-primary/30 overflow-hidden">
                  {/* Destination Image */}
                  <div className="relative h-64 sm:h-80 lg:h-96 bg-brand-menu-hover">
                    <div className="absolute inset-0 flex items-center justify-center text-brand-heading/20">
                      <MapPin className="h-32 w-32" />
                    </div>
