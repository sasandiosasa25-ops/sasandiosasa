          ...
          <div className="mt-8 rounded-3xl border border-white/12 bg-white/8 p-6 sm:p-8 shadow-sm backdrop-blur-md">
            ...
            <div className="mt-4 grid gap-4 md:grid-cols-2">
              <div className="rounded-2xl border border-white/12 bg-white/10 p-4 backdrop-blur-sm">
                <h5 className="text-base font-semibold text-[#dbfffd]">Before the Mountain</h5>
              ...
              <div className="rounded-2xl border border-white/12 bg-white/10 p-4 backdrop-blur-sm">
                <h5 className="text-base font-semibold text-[#dbfffd]">Preparation Day</h5>
              ...
              <div className="rounded-2xl border border-white/12 bg-white/10 p-4 backdrop-blur-sm">
                <h5 className="text-base font-semibold text-[#dbfffd]">On the Mountain</h5>
              ...
              <div className="rounded-2xl border border-white/12 bg-white/10 p-4 backdrop-blur-sm">
                <h5 className="text-base font-semibold text-[#dbfffd]">Beyond the Summit</h5>
